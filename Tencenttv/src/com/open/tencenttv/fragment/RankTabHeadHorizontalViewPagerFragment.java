...
//    RankViewPagerAdapter mRankViewPagerAdapter;
    ...
    public static RankTabHeadHorizontalViewPagerFragment newInstance(MainUpView mainUpView1, View mOldView, EffectNoDrawBridge mEffectNoDrawBridge) {
...
//            // 初始化.
    ...
    public void onCallback(CommonT result) {
        ...
        for(RankBean bean:result.getTitlerankList()){
            ...
            RankTabHorizontalViewPagerFragment fragment = RankTabHorizontalViewPagerFragment.newInstance(mainUpView1,mOldView,mEffectNoDrawBridge);
//            RankFragment fragment = RankFragment.newInstance("",mainUpView1,mOldView,mEffectNoDrawBridge);
    ...
    public ArrayList<RankBean> parseTitleRank(String href) {
        ...
        try {
             ...
             * <ul class="mod_rankbox_area_list" _group="iarea">
				...
				<li><a href="http://v.qq.com/rank/detail/2_-1_-1_-1_2_1.html">内地</a></li>
				<li><a href="http://v.qq.com/rank/detail/2_-1_-1_-1_2_2.html">香港</a></li>
				<li><a href="http://v.qq.com/rank/detail/2_-1_-1_-1_2_3.html">台湾</a></li>
				<li><a href="http://v.qq.com/rank/detail/2_-1_-1_-1_2_4.html">韩国</a></li>
				<li><a href="http://v.qq.com/rank/detail/2_-1_-1_-1_2_9999.html">其他</a></li>
				</ul>
             */
            // 解析文件
