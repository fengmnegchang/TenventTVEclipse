 ...
 *               *********************************************
 */
public class RankFragment extends BaseV4Fragment<RankJson, RankFragment> {
	...
	public ArrayList<RankBean> parseRankList(String href) {
		...
		try {
			...
			/**
			 * <li>
			 * <span class="mod_rankbox_con_list_index top_3">01</span> <span
			 * class="mod_rankbox_con_item_title"><a
			 * href="http://v.qq.com/cover/b/bnc0cvuskzxnrcl.html"
			 * target="_blank" title="可可小爱公益动画">可可小爱公益动画</a></span> <span
			 * class="mod_rankbox_con_item_actor"> 儿童国学 儿童益智 </span> <span
			 * class="mod_rankbox_con_item_impor">&nbsp;</span> <!--<span
			 * class="mod_rankbox_con_list_click"><strong
			 * class="num">780.9万</strong></span> --> <span
			 * class="mod_rankbox_con_list_click"><strong
			 * class="num">780.8万</strong></span></li>
			 */
			// 解析文件
