 ...
 *               *********************************************
 */
public class UserSubscribeTabHorizontalViewPagerFragment extends BaseV4Fragment<RankJson> implements OpenTabHost.OnTabSelectListener {
	...
	public static UserSubscribeTabHorizontalViewPagerFragment newInstance(MainUpView mainUpView1, View mOldView, EffectNoDrawBridge mEffectNoDrawBridge) {
	...
	public RankJson call() throws Exception {
		...
		try {
			list = parseTitleRank(UrlUtils.TENCENT_U_SUBSCRIBE);
	...
	public ArrayList<RankBean> parseTitleRank(String href) {
		...
		try {
			...
			/**
			 * <ul class="mod_tab_list related_list cf" style="margin-bottom: 0;">
			 * <li class="item current" data-idx='0'><a href="javascript:;"
			 * class="txt link">用户<i class="nums"
			 * style="display:none;">(0)</i></a></li>
			 * <li class="item link" data-idx='1'><a href="javascript:;"
			 * class="txt link">球队/球星<i class="nums"
			 * style="display:none;">(0)</i></a></li>
			 * </ul>
			 */
			// 解析文件
