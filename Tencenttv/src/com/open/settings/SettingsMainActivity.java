		...
		floatbtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (XiaoMiRomUtils.isMIUIforReflect()) {
					openMiuiPermissionActivity(SettingsMainActivity.this);
					checkOp(SettingsMainActivity.this, 0);
				} 
//				Intent intent = new Intent(Settings.ACTION_MANAGE_OVERLAY_PERMISSION);
//			    startActivity(intent);
			}
		...
		autostartbtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startFloat(SettingsMainActivity.this, "请允许“settingsprj”开机自启动");
			}
		});
		...
		startsevicebtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startFloat(SettingsMainActivity.this, "请在服务中开启“文字锁屏”");
			}
		});
		...
		screenbtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startFloat(SettingsMainActivity.this, "1.请打开【开发者选项】\n 2.请勾选【直接进入系统】");
			}
		});
		...
		broadbtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				mHandler.postDelayed(new Runnable() {
					@Override
					public void run() {
						Intent intent = new Intent("com.open.settings.TopTaskReceiver.FLAG");
		...
		toastbtn.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				int resultOp = CheckPermissionUtils.checkPermiion(SettingsMainActivity.this, 11);
				if (resultOp == 0) {
					Toast.makeText(SettingsMainActivity.this, "允许通知", Toast.LENGTH_LONG).show();
				} else {
					// className =
		...
		allpermissionlistbtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent();
				intent.setClass(SettingsMainActivity.this, AppOpsActivity.class);
				SettingsMainActivity.this.startActivity(intent);
			}
		});
		...
		settingsbtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent();
				intent.setClass(SettingsMainActivity.this, SettingActivity.class);
				SettingsMainActivity.this.startActivity(intent);
			}
		});
		...
		xiaomibtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent();
				intent.setClass(SettingsMainActivity.this, XiaoMiActivity.class);
				startActivity(intent);
			}
		});
		...
		startappbtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				 try {
					 ...
					 startAppLaunchIntentForPackage(SettingsMainActivity.this,"com.example.screenrecordprj");
				} catch (Exception e) {
				}
			}
		});
		...
		huaweibtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent();
				intent.setClass(SettingsMainActivity.this, HuaWeiActivity.class);
				startActivity(intent);
			}
		});
		...
		voicebtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent();
				intent.setClass(SettingsMainActivity.this, VoicePermissionActivity.class);
				startActivity(intent);
			}
		});
